...
// ToProto returns the pluginrpcv1beta1.Code for the given Code.
//
// Returns pluginrpcv1beta1.Code_CODE_UNKNOWN if the Code is not valid.
func (c Code) ToProto() pluginrpcv1beta1.Code {
	if isValidCode(c) {
		return pluginrpcv1beta1.Code(c)
	}
	return pluginrpcv1beta1.Code_CODE_UNKNOWN
}

// CodeForProto returns the Code for the pluginrpcv1beta1.Code.
//
// Returns CodeUnknown if the pluginrpcv1beta1.Code is not valid.
func CodeForProto(protoCode pluginrpcv1beta1.Code) Code {
